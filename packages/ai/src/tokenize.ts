// ---------------------------------------------------------------------------
// Tokenisation for keyword search (BM25 in memory recall)
// ---------------------------------------------------------------------------
//
...
/**
 * Override the tokeniser used by keyword search — e.g. to plug in a dictionary
 * segmenter like jieba for Chinese:
 *
 * ```ts
